  ...
  def set
    ...
    respond_to do |format|
      begin
        ...
        format.html { redirect_to admin_taxons_url, notice: Spree.t(:configuration_set_successfully) }
      rescue
        @configuration = Spree::TaxonBannerConfiguration.new
        format.html { render action: "edit_config", notice: Spree.t(:configuration_set_failed) }
      end
    end
  end
