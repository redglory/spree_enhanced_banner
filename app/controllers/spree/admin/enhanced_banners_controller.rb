  ...
  module Admin
    class EnhancedBannersController < Spree::Admin::BaseController
      ...
      def create
        ...
        respond_to do |format|
          if @image.save
            format.html { redirect_to admin_taxon_enhanced_banners_path(:taxon_id => @taxon.id), notice: Spree.t(:banner_successfully_created) }
          else
            @image = Spree::Image.new
            format.html { render action: "new", notice: Spree.t(:banner_unsuccessfully_created) }
          end
        end
      end
      ...
      def destroy
        ...
        respond_to do |format|
          format.html { render action: "index", notice: Spree.t(:banner_successfully_removed) }
          format.js { render :partial => "spree/admin/shared/destroy", notice: Spree.t(:banner_successfully_removed) }
        end
      end
