        ...
        respond_to do |format|
          begin
            Spree::TaxonBannerConfiguration.transaction do
              ...
              format.html { redirect_to edit_admin_general_settings_url, notice: Spree.t(:configuration_successfully_saved) }
            end
          rescue
            format.html { render action: "edit", notice: Spree.t(:configuration_unsuccessfully_saved) }
          end
        end
      end
